    ...
    <footer className={styles.footer} role="contentinfo" id="contatti">
      <div className={styles.inner}>
        ...
        <div className={styles.top}>
          ...
          <address className={styles.col}>
            ...
            <ul role="list">
              ...
              <li>
                <a href="mailto:info@terraviva.it">info@terraviva.it</a>
              </li>
              <li>
        ...
        <div className={styles.bottom}>
          <p>© {year} TerraViva – Agricoltura Biologica. P.IVA 00000000000</p>
          <p>Coltivato con rispetto. Raccontato con onestà.</p>
        </div>
      </div>
    </footer>
  );
